...
export class LootBuilder {
  static treasureTables = {
    ...
    tables: [{
      ...
      items: [
        ...
        // CUSTOM
        { name: 'Jade dust', description: 'Pinch of powdered jade', img: 'icons/commodities/materials/powder-teal.webp' },
      ]
    }, {
      valueInGp: 50,
  ...
  static trinkets = {
    ...
    systemItems: [
      ...
      { name: 'Silver', pack: SYSTEM_PACKS.TRADE_GOODS }, //5
      { name: 'Wheat', pack: SYSTEM_PACKS.TRADE_GOODS },
    ],
    items: [
      { name: 'Charcoal', description: 'Chunk of charcoal.', weight: 1, price: 1, coinType: 'gp', img: 'icons/commodities/stone/ore-pile-iron-black.webp' },
      ...
      { name: 'Bone dust', description: 'Small amount of bone dust.', weight: 0, price: 1, coinType: 'cp', img: 'icons/commodities/materials/powder-grey.webp' },
      { name: 'Iron filings', description: 'Small amount of powdered iron and iron filings.', weight: 0.1, price: 2, coinType: 'cp', img: 'icons/commodities/materials/powder-black.webp' },
      { name: 'Oak bark', description: 'Handful of oak bark, good for magic and infusions.', weight: 0, price: 3, coinType: 'cp', img: 'icons/commodities/wood/bark-beige.webp' },
      { name: 'Strip of cloth', description: 'Strip of white cloth. Can be used for magic or as an improvised bandage.', weight: 0, price: 1, coinType: 'cp', img: 'icons/sundries/scrolls/scroll-worn-rolled-beige.webp' },
      { name: 'Silver wire', description: 'Piece of fine silver wire.', weight: 0, price: 1, coinType: 'sp', img: 'icons/commodities/metal/chain-silver.webp' },
      ...
      { name: 'Animal fur', description: 'Scraps of animal fur.', weight: 0.2, price: 5, coinType: 'cp', img: 'icons/commodities/leather/fur-brown-gold.webp' },
      ...
      { name: 'Glass rod', description: 'Glass rod.', weight: 0.5, price: 1, coinType: 'ep', img: 'icons/weapons/wands/wand-gem-purple.webp' },
      { name: 'Silver pin', description: 'Silver pin.', weight: 0.1, price: 1, coinType: 'ep', img: 'icons/commodities/metal/pin-cottar-steel.webp' },
      { name: 'Glass totem', description: 'Glass totem.', weight: 0.2, price: 2, coinType: 'sp', img: 'icons/environment/creatures/gargoyle-grey-blue.webp' },
      ...
      { name: 'Soot', description: 'Small amount of soot, can help to light a fire.', weight: 0, price: 1, coinType: 'cp', img: 'icons/commodities/materials/bowl-powder-grey.webp' },
      ...
      { name: 'Holly berries', description: 'Bunch of holly berries.', weight: 0.5, price: 5, coinType: 'cp', img: 'icons/commodities/flowers/holly-buds-red.webp' },
      { name: 'Clay pot', description: 'Pot made of clay.', weight: 0.5, price: 1, coinType: 'sp', img: 'icons/containers/kitchenware/vase-clay-pot-decorated-red.webp' },
      { name: 'Glowworm', description: 'Glowworm, barely emits any light.', weight: 0, price: 1, coinType: 'sp', img: 'icons/environment/creatures/bug-worm-glow.webp' },
      { name: 'Lump of phosphorus', description: 'Lump of phosphorus, highly flammable.', weight: 0.2, price: 1, coinType: 'ep', img: 'icons/commodities/materials/slime-thick-green.webp' },
      { name: 'Carrot', description: 'Carrot, a horse would love it.', weight: 0.2, price: 1, coinType: 'cp', img: 'icons/consumables/vegetable/root-carrot-orange.webp' },
      ...
      { name: 'Bird feather', description: 'Feather from a bird.', weight: 0, price: 2, coinType: 'sp', img: 'icons/commodities/materials/feather-white.webp' },
      ...
      { name: 'Beans', description: 'Handful of beans, enough for a full day when cooked.', weight: 1, price: 1, coinType: 'cp', img: 'icons/consumables/vegetable/lima-beans-pod-brown.webp' },
      ...
      { name: 'Dried grasshopper', description: 'Dried grasshopper.', weight: 0, price: 1, coinType: 'cp', img: 'icons/environment/creatures/bug-ant-red.webp' },
      ...
      { name: 'Molasses', description: 'Molasses.', weight: 0.2, price: 1, coinType: 'gp', img: 'icons/consumables/drinks/wine-amphora-clay-red.webp' },
      ...
      { name: 'Heart', description: 'Heart of a once living creature.', weight: 0.5, price: 1, coinType: 'cp', img: 'icons/commodities/biological/organ-heart-red.webp' },
      { name: 'Pile of bones', description: 'Pile of dried bones.', weight: 0.5, price: 1, coinType: 'cp', img: 'icons/commodities/bones/bones-stack-brown.webp' },
      ...
      { name: 'Humanoid skull', description: 'Well preserved humanoid skull.', weight: 0.5, price: 1, coinType: 'cp', img: 'icons/commodities/bones/skull-hollow-white.webp' },
      { name: 'Sharp tooth', description: 'Really sharp tooth from a hunter creature.', weight: 0.2, price: 1, coinType: 'cp', img: 'icons/commodities/bones/tooth-canine-white.webp' },
      ...
      { name: 'Hair trophy', description: 'Braided hair from a defeated foe or loved one.', weight: 0, price: 1, coinType: 'cp', img: 'icons/commodities/materials/hair-braid-gold.webp' },
      ...
      { name: 'Assorted berries', description: 'Bunch of berries from multiple plants, should be enough food for a day.', weight: 1, price: 1, coinType: 'cp', img: 'icons/consumables/fruit/berries-hanging-red.webp' },
      { name: 'Loaf of bread', description: 'Loaf of bread, should be enough food for a day.', weight: 1, price: 1, coinType: 'cp', img: 'icons/consumables/grains/bread-loaf-boule-rustic-brown.webp' },
      ...
      { name: 'Tattered book', description: 'Tattered but almost complete book.', weight: 2, price: 5, coinType: 'gp', img: 'icons/sundries/books/book-worn-brown-grey.webp' },
      ...
      { name: 'Folded flag', description: 'Folded flag.', weight: 1, price: 1, coinType: 'sp', img: 'icons/sundries/flags/banner-symbol-claw.webp' },
      { name: 'Iron key', description: 'Key made of iron.', weight: 0.4, price: 1, coinType: 'cp', img: 'icons/sundries/misc/key-steel.webp' },
      ...
      { name: 'Mortar and pestle', description: 'Mortar and pestle.', weight: 0.5, price: 1, coinType: 'sp', img: 'icons/tools/cooking/mortar-yellow.webp' },
      { name: 'Iron nails', description: 'Some iron nails.', weight: 0.2, price: 1, coinType: 'sp', img: 'icons/tools/fasteners/nails-worn-steel.webp' },
  ...
  static #prepareTreasure(itemData, lootType, price) {
    return this.#prepareItem({
      ...itemData,
      lootType: itemData.lootType ?? lootType,
      price,
      description: `${itemData.description}, valued around ${price}gp.`,
      rarity: price > 500 ? ITEM_RARITY.UNCOMMON : ITEM_RARITY.COMMON
    });
  }
